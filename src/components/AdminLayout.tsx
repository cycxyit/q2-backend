        ...
        <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: 'var(--bg-color)' }}>
            ...
            <aside style={{ width: '250px', backgroundColor: 'var(--text-dark)', color: 'white', padding: '2rem' }}>
                <div style={{ marginBottom: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.8rem' }}>
                    ...
                    <h2 style={{ margin: 0, fontSize: '1.2rem', textAlign: 'center', lineHeight: '1.3', color: 'var(--text-orange)' }}>承品MEMBER'S DAY<br /><span style={{ fontSize: '1rem' }}>淘货网</span></h2>
                </div>
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <Link to="/admin/announcements" style={{ color: 'white', opacity: 0.8 }}>Announcements</Link>
